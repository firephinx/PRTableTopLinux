...
void personalRobotics::createCloud(const cv::Mat lookupX, const cv::Mat lookupY, const cv::Mat &depth, const cv::Mat &color, pcl::PointCloud<pcl::PointXYZRGB>::Ptr &cloud) const
{
...
cv::Point personalRobotics::convertPointCloudPointToRGBImageCoordinates(pcl::PointXYZRGB)
{
